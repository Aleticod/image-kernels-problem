...
int main(int argc, char *argv[]) {
	...
	{
	case 1:
		applyKernel(imageMatrix, resultMatrix, BLUR, width, height, 10000);
		break;
	case 2:
		applyKernel(imageMatrix, resultMatrix, BOTTOM_SOBEL, width, height, 1);
		break;
	case 3:
		applyKernel(imageMatrix, resultMatrix, EMBOSS, width, height, 1);
		break;
	case 4:
		applyKernel(imageMatrix, resultMatrix, IDENTITY, width, height, 1);
		break;
	case 5:
		applyKernel(imageMatrix, resultMatrix, LEFT_SOBEL, width, height, 1);
		break;
	case 6:
			applyKernel(imageMatrix, resultMatrix, OUTLINE, width, height, 1);
		break;
	case 7:
		applyKernel(imageMatrix, resultMatrix, RIGHT_SOBEL, width, height, 1);
		break;
	case 8:
		applyKernel(imageMatrix, resultMatrix, SHARPEN, width, height, 1);
		break;
	case 9:
		applyKernel(imageMatrix, resultMatrix, TOP_SOBEL, width, height, 1);
		break;
	default:
		break;
	}
	...
	// Write the image results pixels into file 
...
void applyKernel(int image[],int result_image[], int kernel[][3], int width, int height, int factor) {
	int prod;
